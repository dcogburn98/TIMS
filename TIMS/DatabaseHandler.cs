...
namespace TIMS
{
    public partial class DatabaseHandler
    {
        ...
        public static List<InvoiceItem> SqlRetrieveItemsFromSupplierSoldAfterLastOrderDate(string supplier)
        {
            ...
            supplierItems = Communication.RetrieveItemsFromSupplier(supplier);
            List<Invoice> invoices = Communication.RetrieveInvoicesByDateRange(lastOrderDate, DateTime.Now);
        ...
        public static Item SqlRetrieveItem(string scannedBarcode)
        {
            ...
            while (reader.Read())
            {
                ...
                List<Item> itemMatches = Communication.CheckItemNumber(d1, true);
        ...
        public static decimal SqlRetrievePropertyFloat(string key)
        {
            decimal property = 0;
            OpenConnection();
