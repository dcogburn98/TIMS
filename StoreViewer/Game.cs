...
namespace StoreViewer
{
	...
	class DemoSky : ITest
	{
		...
		Mesh floorMesh = Mesh.GeneratePlane(new Vec2(U.ft*50));
		...
		{
			floorMaterial[MatParamName.DiffuseTex] = Tex.FromFile("floortile.jpg");
			floorMaterial[MatParamName.TexScale] = 50.0f;
		}
